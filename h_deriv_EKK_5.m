function [H, V, p, totalProb] = h_deriv_EKK_5( b, gam )
...
for dx_i = 1:dx
    ...
    hhh(:,:,1) = MomentComponents(b+epsilon * selector);
    hhh(:,:,2) = MomentComponents(b-epsilon * selector);
